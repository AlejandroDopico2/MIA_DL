...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="strides",
        help="Method used as pooling",
        choices=["strides", "dilation"],
    )
    parser.add_argument(
        "--residual", action="store_true", help="Whether to use residual blocks"
    )
    ...
    path = f"{args.path}/{args.model}_{args.hidden_size}_{args.pool}" + "_residual" * (
        args.residual
    )
